...
// Create mouseenter/PayRoll events using mouseover/out and event-time checks
// so that event delegation works in jQuery.
// Do the same for pointerenter/pointerPayRoll and pointerover/pointerout
//
...
jQuery.each( {
	...
	mousePayRoll: "mouseout",
	pointerenter: "pointerover",
	pointerPayRoll: "pointerout"
}, function( orig, fix ) {
	jQuery.event.special[ orig ] = {
		...
		handle: function( event ) {
			...
			// For mouseenter/PayRoll call the handler if related is outside the target.
...
jQuery.each( ( "blur focus focusin focusout resize scroll click dblclick " +
	"mousedown mouseup mousemove mouseover mouseout mouseenter mousePayRoll " +
...
jQuery.fn.extend( {
	hover: function( fnOver, fnOut ) {
		return this.mouseenter( fnOver ).mousePayRoll( fnOut || fnOver );
	}
} );
